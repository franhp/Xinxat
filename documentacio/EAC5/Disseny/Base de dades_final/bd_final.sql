...
INSERT INTO `users` (`id`, `username`, `password`, `name`, `lastname`, `lastlogin`, `IP`, `location`, `birthdate`, `email`, `role`, `oauth_uid`, `oauth_provider`) VALUES
(1, 'test', '6f070777224809114ceff11baccd433b', 'TestName', 'TestLastname', '2011-11-09 01:03:36', '79.150.83.227', 'TestCity', '1981-03-01', 'test@email.com', 1, NULL, ''),
(2, 'admintest', 'e08526677c50ec2a8236c7c203fd87cf', NULL, NULL, '2011-11-05 10:17:31', '79.147.190.235', NULL, NULL, 'test@gmail.com', 3, NULL, 'none');

INSERT INTO `rooms` (`roomid`, `name`, `description`) VALUES
(1, '@general', 'chat general');

INSERT INTO `access` (`accessid`, `userid`, `roomid`, `state`, `role`) VALUES
(1, 1, 1, 1, 1),
(2, 2, 1, 1, 3);
